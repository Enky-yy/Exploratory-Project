# ===============================================================
# 🏔️ Slope Failure Risk Prediction using XGBoost + Interactive SHAP
# ===============================================================
...
# ===============================================================
# 6️⃣ SHAP Explainability (Interactive)
# ===============================================================
print("\n🧠 Generating SHAP explainability plots (interactive)...")

# Initialize SHAP
shap.initjs()  # enables interactive JS visualizations (if in notebook/Jupyter)
...
joblib.dump(explainer, "SlopeFailureExplainer.joblib")
print("💾 SHAP explainer saved as 'SlopeFailureExplainer.joblib'")
...
plt.figure()
shap.plots.waterfall(shap_values_failure[high_risk_idx], show=True)  # 👈 popup
...
# ✅ Summary
# ===============================================================
print("\n✅ Model & SHAP visualization complete.")
print("📂 Plots also saved in: shap_outputs/")
